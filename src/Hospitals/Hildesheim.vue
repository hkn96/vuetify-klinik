...
<script>
import kjson from '../assets/klinik by klinik json/AMEOS Klinikum Hildesheim_klinikDe.json';
import gjson from '../assets/klinik by klinik json/AMEOS Klinikum Hildesheim_googleMaps.json';
      ...
      images: [
        {
          ...
          src: require('../images-klinikbewertungen/FachbereichPolarities/FachbereichPolarities_AMEOS Klinikum Hildesheim.png'),
        },
        {
          name: 'PolaritiyProJahr',
          src: require('../images-klinikbewertungen/PolaritiyProJahr/PolaritiyProJahr_AMEOS Klinikum Hildesheim.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-klinikbewertungen/KommentareProJahr/KommentareProJahr_AMEOS Klinikum Hildesheim.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-klinikbewertungen/PositiveNegativeProJahr/PositiveNegativeProJahr_AMEOS Klinikum Hildesheim.png'),
        },
      ],
      googleimages: [
        {
          name: 'PolaritiyProJahr',
          src: require('../images-google/PolaritiyProJahr/PolaritiyProJahr_AMEOS Klinikum Hildesheim_google.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-google/KommentareProJahr/KommentareProJahr_AMEOS Klinikum Hildesheim_google.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-google/PositiveNegativeProJahr/PositiveNegativeProJahr_AMEOS Klinikum Hildesheim_google.png'),
        },
      ],
    };
  },
