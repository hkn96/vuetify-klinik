...
<script>
import kjson from '../assets/klinik by klinik json/KRH Klinikum Agness Karll Laatzen_klinikDe.json';
import gjson from '../assets/klinik by klinik json/KRH Klinikum Agness Karll Laatzen_googleMaps.json';
      ...
      images: [
        {
          ...
          src: require('../images-klinikbewertungen/FachbereichPolarities/FachbereichPolarities_KRH Klinikum Agness Karll Laatzen.png'),
        },
        {
          name: 'PolaritiyProJahr',
          src: require('../images-klinikbewertungen/PolaritiyProJahr/PolaritiyProJahr_KRH Klinikum Agness Karll Laatzen.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-klinikbewertungen/KommentareProJahr/KommentareProJahr_KRH Klinikum Agness Karll Laatzen.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-klinikbewertungen/PositiveNegativeProJahr/PositiveNegativeProJahr_KRH Klinikum Agness Karll Laatzen.png'),
        },
      ],
      googleimages: [
        {
          name: 'PolaritiyProJahr',
          src: require('../images-google/PolaritiyProJahr/PolaritiyProJahr_KRH Klinikum Agnes Karll Laatzen_google.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-google/KommentareProJahr/KommentareProJahr_KRH Klinikum Agnes Karll Laatzen_google.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-google/PositiveNegativeProJahr/PositiveNegativeProJahr_KRH Klinikum Agnes Karll Laatzen_google.png'),
        },
      ],
    };
  },
