...
<script>
import kjson from '../assets/klinik by klinik json/Psychiatrische Klinik Lüneburg_klinikDe.json';
import gjson from '../assets/klinik by klinik json/Psychiatrische Klinik Lüneburg_googleMaps.json';
      ...
      images: [
        {
          ...
          src: require('../images-klinikbewertungen/FachbereichPolarities/FachbereichPolarities_Psychiatrische Klinik Lüneburg.png'),
        },
        {
          name: 'PolaritiyProJahr',
          src: require('../images-klinikbewertungen/PolaritiyProJahr/PolaritiyProJahr_Psychiatrische Klinik Lüneburg.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-klinikbewertungen/KommentareProJahr/KommentareProJahr_Psychiatrische Klinik Lüneburg.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-klinikbewertungen/PositiveNegativeProJahr/PositiveNegativeProJahr_Psychiatrische Klinik Lüneburg.png'),
        },
      ],
      googleimages: [
        {
          name: 'PolaritiyProJahr',
          src: require('../images-google/PolaritiyProJahr/PolaritiyProJahr_Psychiatrische Klinik Lüneburg_google.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-google/KommentareProJahr/KommentareProJahr_Psychiatrische Klinik Lüneburg_google.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-google/PositiveNegativeProJahr/PositiveNegativeProJahr_Psychiatrische Klinik Lüneburg_google.png'),
        },
      ],
    };
  },
