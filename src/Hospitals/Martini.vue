...
<script>
import kjson from '../assets/klinik by klinik json/St. Martini Krankenhaus_klinikDe.json';
import gjson from '../assets/klinik by klinik json/St. Martini Krankenhaus_googleMaps.json';
      ...
      images: [
        {
          ...
          src: require('../images-klinikbewertungen/FachbereichPolarities/FachbereichPolarities_St. Martini Krankenhaus.png'),
        },
        {
          name: 'PolaritiyProJahr',
          src: require('../images-klinikbewertungen/PolaritiyProJahr/PolaritiyProJahr_St. Martini Krankenhaus.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-klinikbewertungen/KommentareProJahr/KommentareProJahr_St. Martini Krankenhaus.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-klinikbewertungen/PositiveNegativeProJahr/PositiveNegativeProJahr_St. Martini Krankenhaus.png'),
        },
      ],
      googleimages: [
        {
          name: 'PolaritiyProJahr',
          src: require('../images-google/PolaritiyProJahr/PolaritiyProJahr_St. Martini Krankenhaus_google.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-google/KommentareProJahr/KommentareProJahr_St. Martini Krankenhaus_google.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-google/PositiveNegativeProJahr/PositiveNegativeProJahr_St. Martini Krankenhaus_google.png'),
        },
      ],
    };
  },
