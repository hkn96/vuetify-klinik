...
<script>
import kjson from '../assets/klinik by klinik json/AMEOS Klinikum Seepark Geestland_klinikDe.json';
import gjson from '../assets/klinik by klinik json/AMEOS Klinikum Seepark Geestland_googleMaps.json';
      ...
      images: [
        {
          ...
          src: require('../images-klinikbewertungen/FachbereichPolarities/FachbereichPolarities_AMEOS Klinikum Seepark Geestland.png'),
        },
        {
          name: 'PolaritiyProJahr',
          src: require('../images-klinikbewertungen/PolaritiyProJahr/PolaritiyProJahr_AMEOS Klinikum Seepark Geestland.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-klinikbewertungen/KommentareProJahr/KommentareProJahr_AMEOS Klinikum Seepark Geestland.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-klinikbewertungen/PositiveNegativeProJahr/PositiveNegativeProJahr_AMEOS Klinikum Seepark Geestland.png'),
        },
      ],
      googleimages: [
        {
          name: 'PolaritiyProJahr',
          src: require('../images-google/PolaritiyProJahr/PolaritiyProJahr_AMEOS Klinikum Seepark Geestland_google.png'),
        },
        {
          name: 'KommentareProJahr ',
          src: require('../images-google/KommentareProJahr/KommentareProJahr_AMEOS Klinikum Seepark Geestland_google.png'),
        },
        {
          name: 'PositiveNegativeProJahr ',
          src: require('../images-google/PositiveNegativeProJahr/PositiveNegativeProJahr_AMEOS Klinikum Seepark Geestland_google.png'),
        },
      ],
    };
  },
